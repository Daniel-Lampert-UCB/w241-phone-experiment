...
```{r}
simple_itt <- data[, lm(screen_time_avg_final ~ treatment + screen_time_avg_initial + as.factor(country))]
...
```{r}
library("ivreg")
ivyreg <- data[, ivreg(screen_time_avg_final ~ treatment |greyscale_binary + screen_time_avg_initial + as.factor(country) + iphone_bi)]
